export const EMPLOYEES = [
  { id: 'E001', name: 'Ahmed Al-Rashidi', role: 'Senior Process Engineer', dept: 'Engineering', avatar: 'AA', color: '#64126D', utilization: 87, location: 'Abu Dhabi', status: 'active', email: 'ahmed.r@accentts.com', phone: '+971 50 123 4567', joined: '2019-03-15', skills: ['Process Design', 'P&ID', 'HAZOP', 'AutoCAD'] },
  { id: 'E002', name: 'Sara Mohammed', role: 'Project Manager', dept: 'PMO', avatar: 'SM', color: '#86288F', utilization: 92, location: 'Dubai', status: 'active', email: 'sara.m@accentts.com', phone: '+971 55 234 5678', joined: '2020-07-01', skills: ['PMP', 'MS Project', 'Risk Management', 'Stakeholder Management'] },
  { id: 'E003', name: 'Khalid Al-Mansouri', role: 'Instrumentation Engineer', dept: 'Engineering', avatar: 'KM', color: '#475569', utilization: 74, location: 'Abu Dhabi', status: 'active', email: 'khalid.m@accentts.com', phone: '+971 56 345 6789', joined: '2021-01-10', skills: ['SCADA', 'DCS', 'PLC', 'Instrumentation Design'] },
  { id: 'E004', name: 'Fatima Al-Zahra', role: 'Civil Engineer', dept: 'Engineering', avatar: 'FZ', color: '#06B6D4', utilization: 65, location: 'Sharjah', status: 'active', email: 'fatima.z@accentts.com', phone: '+971 52 456 7890', joined: '2022-04-20', skills: ['Structural Analysis', 'AutoCAD Civil 3D', 'STAAD Pro'] },
  { id: 'E005', name: 'Omar Hassan', role: 'Mechanical Engineer', dept: 'Engineering', avatar: 'OH', color: '#16A34A', utilization: 81, location: 'Abu Dhabi', status: 'active', email: 'omar.h@accentts.com', phone: '+971 54 567 8901', joined: '2018-09-05', skills: ['Piping Design', 'Stress Analysis', 'CAESAR II', 'PDMS'] },
  { id: 'E006', name: 'Noor Al-Sabah', role: 'Electrical Engineer', dept: 'Engineering', avatar: 'NS', color: '#F59E0B', utilization: 78, location: 'Dubai', status: 'active', email: 'noor.s@accentts.com', phone: '+971 58 678 9012', joined: '2020-11-15', skills: ['Electrical Design', 'ETAP', 'HV/LV Systems', 'Load Calculations'] },
  { id: 'E007', name: 'Tariq Malik', role: 'HSE Manager', dept: 'HSE', avatar: 'TM', color: '#DC2626', utilization: 55, location: 'Abu Dhabi', status: 'active', email: 'tariq.m@accentts.com', phone: '+971 50 789 0123', joined: '2017-02-28', skills: ['ISO 14001', 'OHSAS 18001', 'Risk Assessment', 'Incident Investigation'] },
  { id: 'E008', name: 'Layla Ibrahim', role: 'Document Controller', dept: 'Admin', avatar: 'LI', color: '#2563EB', utilization: 60, location: 'Abu Dhabi', status: 'active', email: 'layla.i@accentts.com', phone: '+971 55 890 1234', joined: '2021-08-01', skills: ['Aconex', 'SharePoint', 'Document Management', 'ISO 9001'] },
];
