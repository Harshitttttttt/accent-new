  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ padding: '16px 28px', borderBottom: '1px solid var(--border)', background: 'var(--surface)', flexShrink: 0 }}>
        <button className="btn-ghost" style={{ marginBottom: 10, fontSize: 12.5 }} onClick={() => onNavigate('projects')}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
            <button className="btn-secondary"><Paperclip size={14} /> Documents</button>
            <button className="btn-secondary"><MessageSquare size={14} /> Discuss</button>
            <button className="btn-primary"><Plus size={14} /> Add Deliverable</button>
          </div>
        </div>
      </div>
          ...
          {activeTab === 'Deliverables' && (
            <div className="card" style={{ overflow: 'hidden' }}>
              <div style={{ padding: '14px 18px', borderBottom: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <button className="btn-primary" style={{ padding: '6px 12px', fontSize: 12 }}><Plus size={13} /> Add Deliverable</button>
              </div>
