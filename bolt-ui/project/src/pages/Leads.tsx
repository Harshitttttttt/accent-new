          ...
          return (
            <div key={stage} className="kanban-col"
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                ...
                <button className="btn-ghost" style={{ padding: '2px 4px' }}><Plus size={14} /></button>
              </div>
                ...
                {stageLeads.map(lead => (
                  <div key={lead.id}
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                      ...
                      <button className="btn-ghost" style={{ padding: '2px 4px' }}><MoreHorizontal size={14} /></button>
                    </div>
              ...
              {/* Add card */}
              <button className="btn-ghost" style={{ width: '100%', justifyContent: 'center', marginTop: 4, fontSize: 12.5, padding: '8px' }}>
